    ...
    <div className="w-full max-w-2xl mx-auto bg-brand-cream rounded-lg shadow-xl">
      <div className="p-5 sm:p-8 md:p-10">
        ...
        {selectedSize === "customize" && (
          <div className="mb-10">
            <div className="flex items-center gap-2 mb-4">
              <span className="flex items-center justify-center min-w-5 h-5 px-1 rounded-full bg-brand-gold text-white text-xs font-semibold">
                2.1
              </span>
        ...
        <div className="border border-gray-200 rounded-lg p-6 bg-white">
          ...
          <a
            ...
            className={`
                flex items-center justify-center gap-3 w-full px-4 py-4
                font-semibold tracking-wider uppercase text-xs sm:text-sm text-white text-center
          ...
          >
            ...
            <span>Request Estimate via WhatsApp</span>
          </a>
        </div>
      </div>
    </div>
